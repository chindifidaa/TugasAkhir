...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        messages: {
            'default': 'Seret dan lepas file disini.',
            'replace': 'Seret dan lepas untuk mengganti file.',
            'remove':  'Hapus',
            'error':   'Ups, terjadi sesuatu yang tidak beres.'
        },
        error: {
            ...
            'imageFormat': 'Format gambar tidak diizinkan (hanya {{ value }} diperbolehkan).',
            'fileExtension': 'Ekstensi file tidak diizinkan (hanya {{ value }} diperbolehkan).'
        },
        tpl: {
