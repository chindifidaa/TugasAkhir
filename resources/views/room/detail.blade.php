            ...
            <div class="col-lg-4">
                <div class="room-booking">
                    ...
                    <form action="#">
                        ...
                        <div class="mb-3">
                            <label for="">Permintaan Khusus</label>
                            <textarea placeholder="Masukan permintaan anda..." class="form-control"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="guest">Metode Pembayaran</label>
                            <select class="form-control">
                                <option selected disabled hidden>Pilih Pembayaran</option>
                                <option value="">Transfer</option>
                                <option value="">Cash</option>
                            </select>
                        </div>
                        <a href="{{ route('payments.rooms')}}">
                            <button class="btn btn-main-primary">Lanjut</button>
                        </a>
                    </form>
                </div>
            </div>
